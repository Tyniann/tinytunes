...
TinyTunes ist **lokal ausgerichtet**: Katalog, Warteschlange, Einstellungen und optionaler Google-Drive-Cache liegen **auf Ihrem Gerät**. Es gibt **keinen** TinyTunes-Server, der Ihre Bibliothek oder Hörhistorie empfängt.

Bei optionaler Google-Anmeldung gelten zusätzlich die Bedingungen und Datenschutzhinweise von **Google** (siehe Abschnitt 6).
...
| --- | --- | --- |
| Bibliothek / Katalog | Ordnerwurzeln, Dateinamen, Locators, optionale Tags (Titel, Interpret, Album) | Indexierung und Anzeige |
...
| Cloud-Cache (optional) | Heruntergeladene Audiodateien und Cache-Metadaten | Wiedergabe von Drive-Titeln |
...
### 3.3 Was wir derzeit nicht tun

Keine eigenen Analytics-/Werbe-Tracker; kein Verkauf von Daten; kein TinyTunes-Cloud-Konto; **kein** Schreiben/Löschen/Umbenennen auf Drive; lokale Musik ohne Google-Konto nutzbar.
...
Google-Sitzung: bis Abmelden oder Widerruf bei Google.  
...
Übermittlungen in Drittländer können bei Google nach deren Mechanismen (z. B. Standardvertragsklauseln) erfolgen.
